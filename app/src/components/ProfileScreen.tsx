  ...
  return (
    <div className="px-6 py-6 space-y-6">
      <div className="mb-8">
        ...
        <h1 className="text-4xl font-black tracking-tight text-primary leading-none uppercase">Bok, Marko!</h1>
        <p className="text-on-surface-variant mt-2 text-sm">Hvala što brineš o čistoći svog kvarta.</p>
      </div>
      ...
      <div className="bg-surface-container-lowest shield-motif p-8 shadow-[0_4px_24px_-4px_rgba(0,68,130,0.06)] flex flex-col items-center text-center">
        ...
        <div className="text-6xl font-black text-primary tracking-tighter mb-2">
          15 <span className="text-2xl text-outline-variant font-light">/ 100</span>
        </div>
      ...
      <div className="bg-surface-container-low shield-motif p-6 flex flex-col gap-4">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-on-surface-variant mt-1">Sakupi bodove recikliranjem i otključaj kupone za javni prijevoz ili ZG vrećice.</p>
          </div>
        </div>
