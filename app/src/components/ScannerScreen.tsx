...
export default function ScannerScreen() {
  ...
  return (
    <div className="px-6 py-6 space-y-6 flex flex-col items-center">
      ...
      {scanState !== 'result' ? (
        <div className="w-full aspect-square bg-surface-container-lowest shield-motif shadow-sm border border-outline-variant/15 flex flex-col items-center justify-center relative overflow-hidden group">
          <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-transparent"></div>
          
          <div className="w-64 h-64 border-2 border-dashed border-primary/20 rounded-xl flex items-center justify-center relative">
            ...
            >
              <div className={`w-24 h-24 bg-primary rounded-full flex items-center justify-center shadow-lg transition-colors ${scanState === 'scanning' ? 'animate-pulse' : 'group-hover:bg-primary-container'}`}>
        ...
        <>
          <div className="w-full aspect-[4/3] bg-surface-container-lowest shield-motif shadow-sm border border-outline-variant/15 flex flex-col items-center justify-center relative overflow-hidden group">
            <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-transparent"></div>
            <div className="w-48 h-32 border-2 border-dashed border-primary/20 rounded-xl flex items-center justify-center relative overflow-hidden">
      ...
      <div className="grid grid-cols-2 gap-4 w-full mt-4">
        <div className="bg-surface-container-low p-4 shield-motif space-y-1">
          ...
          <p className="text-[9px] font-bold uppercase tracking-tight text-on-surface-variant">Ukupna Ušteda CO2</p>
          <p className="text-lg font-black text-primary">0.45 kg</p>
        </div>
        <div className="bg-surface-container-low p-4 shield-motif space-y-1">
          <History className="text-primary w-5 h-5 mb-2" />
          <p className="text-[9px] font-bold uppercase tracking-tight text-on-surface-variant">Skenirano danas</p>
          <p className="text-lg font-black text-primary">3 puta</p>
        </div>
      </div>
    </div>
  );
